...
// This file is the C# compositor that loads AFTER the BIOS disk image issues MEMBRANE_PASS.
//
// Pipeline:
//   make image
//   → QEMU loads build/mmuko-os.img → MBR/VBR/stage-2 → NSIGII 6-phase calibration
